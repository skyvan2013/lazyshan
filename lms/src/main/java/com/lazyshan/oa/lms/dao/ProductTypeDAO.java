package com.lazyshan.oa.lms.dao;
 ...
 * 
 * @see com.lazyshan.oa.lms.model.ProductType
...
public class ProductTypeDAO {
	...
	public List<ProductType> findByExample(ProductType instance) {
		...
		try {
			List<ProductType> results = (List<ProductType>) getCurrentSession()
					.createCriteria("com.lazyshan.oa.lms.model.ProductType")
	...
	public List<ProductType> findByProductTypeDesc(Object productTypeDesc) {
		return findByProperty(PRODUCT_TYPE_DESC, productTypeDesc);
	}
