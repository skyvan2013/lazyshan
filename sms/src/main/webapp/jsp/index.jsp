			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="alert alert-block alert-success">
						...
						<i class="icon-ok green"></i> 欢迎使用 <strong class="green"> Ace后台管理系统 <small>(v1.2)</small>
							...
							<div class="widget-box">
								<div class="widget-header widget-header-flat widget-header-small">
									...
									<div class="widget-toolbar no-border">
										...
										<ul class="dropdown-menu pull-right dropdown-125 dropdown-lighter dropdown-caret">
											<li class="active"><a href="#" class="blue"> <i class="icon-caret-right bigger-110">&nbsp;</i> 本周
											</a></li>

											<li><a href="#"> <i class="icon-caret-right bigger-110 invisible">&nbsp;</i> 上周
											</a></li>

											<li><a href="#"> <i class="icon-caret-right bigger-110 invisible">&nbsp;</i> 本月
											</a></li>

											<li><a href="#"> <i class="icon-caret-right bigger-110 invisible">&nbsp;</i> 上月
											</a></li>
										</ul>
									</div>
								</div>
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="clearfix">
											<div class="grid3">
												<span class="grey"> <i class="icon-facebook-sign icon-2x blue"></i> &nbsp; likes
												</span>
										...
										<table class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td class="hidden-480"><span class="label label-success arrowed-in arrowed-in-right">可用</span></td>
												</tr>
												...
												<tr>
													...
													<td class="hidden-480"><span class="label arrowed"> <s>无货</s>
													</span></td>
												</tr>
												...
												<tr>
													...
													<td class="hidden-480"><span class="label label-warning arrowed arrowed-right">售完</span></td>
												</tr>
											</tbody>
										</table>
									</div>
										...
										<div class="tab-content padding-8 overflow-visible">
											<div id="task-tab" class="tab-pane active">
												...
												<ul id="tasks" class="item-list">
													<li class="item-orange clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> 问答</span>
													</label>
													...
													<li class="item-red clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> BUG修复</span>
													</label>

														<div class="pull-right action-buttons">
															<a href="#" class="blue"> <i class="icon-pencil bigger-130"></i>
															</a> <span class="vbar"></span> <a href="#" class="red"> <i class="icon-trash bigger-130"></i>
															</a> <span class="vbar"></span> <a href="#" class="green"> <i class="icon-flag bigger-130"></i>
															</a>
														</div></li>

													<li class="item-default clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl">添加新的特征</span>
													</label>
														...
														<div class="inline pull-right position-relative dropdown-hover">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-caret dropdown-close pull-right">
																<li><a href="#" class="tooltip-success" data-rel="tooltip" title="Mark&nbsp;as&nbsp;done"> <span class="green"> <i class="icon-ok bigger-110"></i>
																	</span>
																</a></li>

																<li><a href="#" class="tooltip-error" data-rel="tooltip" title="Delete"> <span class="red"> <i class="icon-trash bigger-110"></i>
																	</span>
																</a></li>
															</ul>
														</div></li>

													<li class="item-blue clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> 更新模版脚本</span>
													</label></li>

													<li class="item-grey clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> 添加新皮肤</span>
													</label></li>

													<li class="item-green clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> 升级服务端</span>
													</label></li>

													<li class="item-pink clearfix"><label class="inline"> <input type="checkbox" class="ace" /> <span class="lbl"> 清理垃圾</span>
													</label></li>
												</ul>
											</div>
											...
											<div id="member-tab" class="tab-pane">
												<div class="clearfix">
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Bob Doe's avatar" src="/statics/assets/avatars/user.jpg" />
														</div>
															...
															<div>
																...
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		<li><a href="#" class="tooltip-success" data-rel="tooltip" title="Approve"> <span class="green"> <i class="icon-ok bigger-110"></i>
																			</span>
																		</a></li>

																		<li><a href="#" class="tooltip-warning" data-rel="tooltip" title="Reject"> <span class="orange"> <i class="icon-remove bigger-110"></i>
																			</span>
																		</a></li>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Joe Doe's avatar" src="/statics/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Jim Doe's avatar" src="/statics/assets/avatars/avatar.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Alex Doe's avatar" src="/statics/assets/avatars/avatar5.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Bob Doe's avatar" src="/statics/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Susan's avatar" src="/statics/assets/avatars/avatar3.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Phil Doe's avatar" src="/statics/assets/avatars/avatar4.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Alexa Doe's avatar" src="/statics/assets/avatars/avatar1.png" />
														</div>
												...
												<div class="center">
													<i class="icon-group icon-2x green"></i> &nbsp; <a href="#"> 查看所有会员 &nbsp; <i class="icon-arrow-right"></i>
													</a>
												</div>
											...
											<div id="comment-tab" class="tab-pane">
												<div class="comments">
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Bob Doe's Avatar" src="/statics/assets/avatars/avatar.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Jennifer's Avatar" src="/statics/assets/avatars/avatar1.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Joe's Avatar" src="/statics/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Rita's Avatar" src="/statics/assets/avatars/avatar3.png" />
														</div>
												...
												<div class="center">
													<i class="icon-comments-alt icon-2x green"></i> &nbsp; <a href="#"> See all comments &nbsp; <i class="icon-arrow-right"></i>
													</a>
												</div>
									...
									<div class="widget-main no-padding">
										<div class="dialogs">
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Alexa's Avatar" src="/statics/assets/avatars/avatar1.png" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="John's Avatar" src="/statics/assets/avatars/avatar.png" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Bob's Avatar" src="/statics/assets/avatars/user.jpg" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Jim's Avatar" src="/statics/assets/avatars/avatar4.png" />
												</div>
