...
<html lang="zh_CN">
	<head>
		...
		<link rel="stylesheet" href="/statics/assets/css/font/font.css" />
	...
	<body>
					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src="/statics/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="/statics/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="/statics/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="/statics/assets/avatars/user.jpg" alt="Jason's Photo" />
		...
		<script src="/statics/assets/js/jquery-2.0.3.min.js"></script>
...
<![endif]-->
		...
		<script src="/statics/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="/statics/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="/statics/assets/js/jquery.slimscroll.min.js"></script>
		<script src="/statics/assets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="/statics/assets/js/jquery.sparkline.min.js"></script>
		<script src="/statics/assets/js/flot/jquery.flot.min.js"></script>
		<script src="/statics/assets/js/flot/jquery.flot.pie.min.js"></script>
		<script src="/statics/assets/js/flot/jquery.flot.resize.min.js"></script>
